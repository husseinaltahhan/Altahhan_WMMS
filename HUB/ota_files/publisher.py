class BoardPublisher():
    ...
    def publish_last_state(self, state, total_production_count, current_cylinder, welded_state):
        self.client.publish(b"boards/esp32_b1/last_state", f"{state} {total_production_count} {current_cylinder} {welded_state}", retain=True)
