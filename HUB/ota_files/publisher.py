class BoardPublisher():
    ...
    def publish_counter(self, count, size):
        self.client.publish(b"boards/esp32_b1/update_counter", f"{count} {size}")
    ...
    def publish_last_state(self, state, total_production_count, total_time):
        self.client.publish(b"boards/esp32_b1/last_state", f"{state} {total_production_count} {total_time}", retain=True)
